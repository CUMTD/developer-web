				...
				<p>
					...
					<div className="grid md:grid-cols-2 grid-cols-1 md:grid-rows-3 grid-rows-2 gap-5">
						...
						<Card className="gap-0! md:col-span-2">
							...
							<CardContent>
								<p>
									If GTFS doesn't cut it, we offer a classic REST API, now in version 3.0. Use simple HTTP GET requests
									to fetch data on MTD service. Requires sign-up and an API key. Beginner friendly.
								</p>
							</CardContent>
							<CardFooter className="mt-auto">
								<div className="flex flex-row gap-4">
