...
function SidebarProvider({
	...
	const [_open, _setOpen] = useState(() => readStorageBoolean(SIDEBAR_STORAGE_KEY, defaultOpen));
	...
	const setOpen = useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			writeStorage(SIDEBAR_STORAGE_KEY, openState);
		},
		[setOpenProp, open],
	);
...
type SidebarInsetProps = ComponentProps<"main"> & {
	scrollMode?: "container" | "viewport";
};

function SidebarInset({ className, scrollMode = "container", ...props }: SidebarInsetProps) {
	return (
		<main
			data-slot="sidebar-inset"
			className={cn(
				"bg-background relative flex w-full flex-1 flex-col",
				scrollMode === "container" ? "overflow-y-scroll" : "overflow-visible",
