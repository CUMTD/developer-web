...
type TwentyFourHourUsageChartProps = Readonly<{
...
export default function TwentyFourHourUsageChart({
	chartData,
	chartConfig,
	chartSeries,
	endpointCount,
}: TwentyFourHourUsageChartProps) {
		...
		<>
			...
			<figure>
				...
				<figcaption id={chartDescriptionId} className="sr-only">
					API requests in the last 24 hours, grouped by hour and endpoint.
